...
curl -w "\n" -s -X 'POST' \
  "http://localhost:$PORT/api/partners/filecoin/contracts/00000000-0000-0000-0000-000000666666/on-chain/deploy" \
  -H "X-API-KEY: $X_API_KEY" \
  -H 'Content-Type: application/json'
...
curl -w "\n" -s -X 'POST' \
  "http://localhost:$PORT/api/partners/filecoin/contracts/00000000-0000-0000-0000-000000666666/on-chain/sign" \
  -H "X-API-KEY: $X_API_KEY" \
  -H 'Content-Type: application/json'
