...
import { Typography, Button, SelectChangeEvent, Box } from '@mui/material';
...
import GenericSelect, {
  SelectOption,
} from '../../components/generic-select/generic-select';
...
const getUserTypes = (isFilecoin: boolean): SelectOption[] => [
  {
    ...
    value: isFilecoin
      ? UserTypeEnumType.STORAGE_PROVIDER
      : UserTypeEnumType.MINER,
  },
